...
<html lang="es">
    ...
    <body>
        ...
        <br>
        <form name="form1" method="post" action="index2.php?accion=guardarCambiosTipoDocumento">
        <p>Id: </p>
        <input type="text" class="field" name="txtid" value="<?php print $_REQUEST['id'];?>" readonly>
        <p>Nombre: </p>
